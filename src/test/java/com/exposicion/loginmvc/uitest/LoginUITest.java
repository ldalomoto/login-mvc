...
// IMPORTANTE: Eliminamos @SpringBootTest para evitar que la aplicación se inicie localmente
// El test ahora asume que la aplicación está corriendo EXTERNAMENTTE en el contenedor 'app-test'
...
        int maxAttempts = 5; // Aumentamos reintentos por si la Grid tarda
